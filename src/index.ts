...
import { BUILTIN_PATTERNS, compilePatterns, redactContent, redactJson, type JsonValue, type SecretPattern } from './redact.js'
...
export type { JsonValue, SecretPattern } from './redact.js'
